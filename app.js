...
function ajouterBlocObjetAuCatalogueVip() {
  ...
  row.innerHTML = `
    ...
    <div class="form-box"><label style="font-size:0.75rem;">Photos du bien VIP</label><input type="file" class="vip-in-photos" multiple accept="image/*" style="border:none; background:transparent; padding:0;"></div>`;
  ...
  for(let n of nodes) {
    ...
    await fetch(`${API}/annonces`, {
      ...
      body: JSON.stringify({
        ...
        description: n.querySelector(".vip-in-desc").value, 
